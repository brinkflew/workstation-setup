# Generated by Powerlevel10k configuration wizard on 2020-09-25 at 14:22 CEST.
...
# 24h time, angled separators, blurred heads, sharp tails, 2 lines, disconnected,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_PUBLIC_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_VIDEOS_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_SSH_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_USER_VISUAL_IDENTIFIER_EXPANSION=''

  typeset -g POWERLEVEL9K_DIR_BOOT_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_BOOT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  typeset -g POWERLEVEL9K_DIR_LIB_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_LIB_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_MEDIA_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_MEDIA_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_MOUNT_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_MOUNT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_RUN_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_RUN_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_BIN_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_BIN_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_SYS_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_SYS_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_TMP_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_TMP_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_USR_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_USR_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_VAR_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_VAR_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_DIR_ROOT_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=11
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=13
